...
void {\bfseries stereo\+\_\+ugv\+::initialize} (std\+::string $\ast$string, const Context \&context)
\item 
...
void {\bfseries stereo\+\_\+ugv\+::initialize} (cv\+::\+Size $\ast$size, const Context \&context)
\item 
...
void {\bfseries stereo\+\_\+ugv\+::initialize} (cv\+::\+Term\+Criteria $\ast$criteria, const Context \&context)
\item 
...
Context {\bfseries stereo\+\_\+ugv\+::open\+Internal\+Context} (nlohmann\+::json $\ast$json, const Context \&context)
